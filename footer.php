...
<footer id="colophon" class="site-footer d-flex">
	<div class="container justify-content-center" style="background-color: #1A2435; flex-direction: column !important; margin-right: 30px; margin-left: 30px;">
		<div class="row">
	...
	<div class="container justify-content-center" style=" background-color: #202C42; flex-direction: column !important; margin-right: 30px; margin-left: 30px;">
		<div class="row">
	...
	<div class="container justify-content-center" style="background-color: #1A2435; flex-direction: column !important; margin-right: 30px; margin-left: 30px;">
		<div class="row">
			<div class="col-md p-3">
				<div class="mt-5" style="font-family: 'EB Garamond'; font-weight: 400;">
					&copy; Copyright <?php echo date('Y'); ?> American Sourcing, Inc. All Rights Reserved.
				</div>
			</div>
		</div>
