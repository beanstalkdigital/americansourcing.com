...
<footer id="colophon" class="site-footer" style="background-color: white;">
	<div class="container-fluid" style="flex-direction: column !important; margin-right: 30px; margin-left: 30px;">
		...
		<div class="row" style="background-color: #202C42;">
			<div class="col-md p-3 text-center">
				<div style="height: 84px; width: 495px; margin: auto;">
		...
		<div class="row" style="background-color: #1A2435;">
			<div class="col-md p-3">
				<div class="mt-5" style="font-family: 'EB Garamond'; font-weight: 400; text-align: center;">
